...
export const tr = {
  ...
  lesson: {
    ...
    cableStart: "Soldan bir görev seç.",
    cablePickRight: "Şimdi doğru pencereyi seç.",
    cablePickLeft: "Önce soldan bir görev seç.",
    cableGood: "Bağlantı oturdu.",
    cableBad: "Bu giriş kabul etmedi. Görevin nerede yapıldığını düşün.",
    ...
    task: "Alıştırma",
    stages: "Aşamalar",
    closeRail: "Aşama listesini kapat",
    openRail: "Aşama listesi",
    lessonProgress: "Ders ilerlemesi",
    mastery: "Kavrama",
    streak: "seri",
    sectionLocked: "Önce sıradaki aşamayı bitir",
    lessonDoneToast: "Ders tamamlandı",
    sectionDoneToast: "Aşama tamamlandı",
