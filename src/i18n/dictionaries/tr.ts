...
export const tr = {
  ...
  auth: {
    ...
    signUpTitle: "Hesabını aç",
    signUpLead: "İlk modül birkaç dakika içinde başlıyor.",
    name: "Ad",
    email: "E-posta",
    password: "Parola",
    ...
    errors: {
      ...
      emailRequired: "E-posta adresini yaz.",
      ...
      wrongCredentials: "E-posta ya da parola hatalı.",
