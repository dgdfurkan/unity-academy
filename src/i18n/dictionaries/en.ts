...
export const en: Dictionary = {
  ...
  lesson: {
    ...
    tryAgain: "Try again",
    reset: "Start over",
    sortHint: "Tap an item, then tap the box it belongs in.",
    sortDone: "Everything is placed.",
    cableStart: "Pick a task on the left.",
    cablePickRight: "Now pick the window it belongs to.",
    cablePickLeft: "Pick a task on the left first.",
    cableGood: "The connection holds.",
    cableBad: "That socket rejected it. Think about where the task happens.",
    hotspotHint: "Tap the points to explore.",
    hotspotEmpty: "Tap a point to read what it is.",
    read: "Read",
    activity: "Try it",
    task: "Practice",
    stages: "Stages",
    closeRail: "Close the stage list",
    openRail: "Stage list",
    lessonProgress: "Lesson progress",
    mastery: "Mastery",
    streak: "streak",
    sectionLocked: "Finish the current stage first",
    lessonDoneToast: "Lesson complete",
    sectionDoneToast: "Stage complete",
